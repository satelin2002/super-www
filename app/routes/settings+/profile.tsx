			...
			<div className="mt-16 flex flex-col gap-12">
				<div className="flex justify-center">
					<div className="relative h-52 w-52">
						...
						<Link
							to="photo"
							className="absolute -right-3 top-3 flex h-4 w-4 items-center justify-center rounded-full border-4 border-day-700 bg-day-500 p-5"
				...
				<Form method="POST" {...form.props}>
					<div className="grid grid-cols-6 gap-x-10">
						...
						<div className="col-span-6 mb-12 mt-6 h-1 border-b-[1.5px] border-day-500" />
						<fieldset className="col-span-6">
							<legend className="pb-6 text-lg text-day-200">
								Change password
							</legend>
