...
export default function NotesRoute() {
	...
	return (
		<div className="flex h-full pb-12">
			<div className="mx-auto grid w-full flex-grow grid-cols-4 bg-day-500 pl-2 md:container md:rounded-3xl">
				...
				<main className="col-span-3 bg-day-400 px-10 py-12 md:rounded-r-3xl">
					<Outlet />
				</main>
			</div>
		</div>
